<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustDeleteGroom.aspx.cs" Inherits="CustDeleteGroom" %>
...
<body bgcolor="#99cccc">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MatriConnectionString %>"
            DeleteCommand="DELETE FROM GroomProfileTab where  ([CustNo] = @CustNo) " SelectCommand="SELECT [CustNo], [RegDate], [uName], [cName], [fName], [Profession], [MNo] FROM [GroomProfileTab] WHERE  ([uName] = @uName) ORDER BY [CustNo]">
            <SelectParameters>

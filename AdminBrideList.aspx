<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminBrideList.aspx.cs" Inherits="AdminBrideList" %>
...
<body backcolor="#99cccc">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Purple" Font-Bold="False"
            ...
            left: 127px; position: absolute; top: 185px" Width="576px">Bride List </asp:HyperLink>
     ...
     <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Names="Verdana"
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            position: absolute; top: 245px" Width="870px" Height="380px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MatriConnectionString %>"
            SelectCommand="SELECT [CustNo], [uName], [cName], [fName], [MNo], [eMail], [Age], [Caste] FROM [BrideProfileTab]  ORDER BY [CustNo] DESC">

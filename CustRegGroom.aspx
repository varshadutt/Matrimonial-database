<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustRegGroom.aspx.cs" Inherits="CustRegGroom" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" Font-Names="Verdana" Font-Size="12pt" Style="z-index: 109;
            left: 435px; position: absolute; top: 1272px" Text="Save" Width="183px" Height="35px" OnClick="Button1_Click" />
        ...
        <asp:Calendar ID="Calendar1" runat="server" BackColor="#FFFFCC" BorderColor="#FFCC66"
            ...
            ForeColor="#663399" Height="163px" ShowGridLines="True" Style="z-index: 149;
            left: 508px; position: absolute; top: 637px" Visible="False" Width="237px" OnSelectionChanged="Calendar1_SelectionChanged">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" Style="z-index: 127; left: 430px;
            position: absolute; top: 696px" Width="197px" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="casteName" DataValueField="casteName">
        </asp:DropDownList>
    ...
    <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 147; left: 241px; position: absolute; top: 1191px" Text="Upload Picture in JPG format"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustSearchGrooms.aspx.cs" Inherits="CustSearchGrooms" %>
...
<body bgcolor="#99cccc">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Purple" Font-Bold="False"
            ...
            left: 128px; position: absolute; top: 180px" Width="576px">Search for Grooms</asp:HyperLink>
        ...
        <asp:Button ID="Button1" runat="server" Height="31px" OnClick="Button1_Click" Style="z-index: 112;
            left: 307px; position: absolute; top: 408px" Text="Search" Width="217px" />

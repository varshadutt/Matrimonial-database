<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustGroomSearchList.aspx.cs" Inherits="CustGroomSearchList" %>
...
<body bgcolor="#99cccc">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MatriConnectionString %>"
            SelectCommand="SELECT [custNo],[cName], [fName], [Add1], [MNo], [eMail], [Dob], [Age], [AnnualIncome], [birthTime] FROM [GroomProfileTab] WHERE (([Age] >= @Age) AND ([Age] <= @Age2) AND ([Caste] = @Caste)) order by memtype desc">
            <SelectParameters>

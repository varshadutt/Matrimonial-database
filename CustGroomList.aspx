<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustGroomList.aspx.cs" Inherits="CustGroomList" %>
...
<body bgcolor="#99cccc">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MatriConnectionString %>"
            SelectCommand="SELECT [CustNo], [RegDate], [cName], [fName], [MNo], [eMail] FROM [GroomProfileTab] WHERE ([uName] = @uName)">
            <SelectParameters>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminDesignation.aspx.cs" Inherits="AdminDesignation" %>
...
<body bgcolor="#ccffcc">
    ...
    <div>
     ...
     <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 103; left: 172px; position: absolute; top: 203px" BackColor="Purple" Font-Size="XX-Large" ForeColor="Thistle" Width="576px">Profession Details Entry</asp:HyperLink>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 104; left: 175px; position: absolute; top: 274px" Text="Profession Name"></asp:Label>

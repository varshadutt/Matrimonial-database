<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustBrideDetails.aspx.cs" Inherits="CustBrideDetails" %>
...
<body bgcolor="#99cccc">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MatriConnectionString %>"
            SelectCommand="SELECT * FROM [BrideProfileTab] WHERE ([CustNo] = @CustNo)">
            <SelectParameters>
